<section id="tools" class="py-24 bg-fn-surface border-y border-white/[0.07]" aria-labelledby="tools-heading">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-fn-text2 text-lg max-w-lg mx-auto leading-relaxed">From PDF conversion to invoice
                generation — free online file tools our users reach for every day.</p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <!-- PDF to Word -->
            <article
                class="tool-card relative bg-fn-bg border border-white/[0.07] rounded-xl p-6 cursor-pointer hover:border-fn-blue/40 hover:-translate-y-1 hover:shadow-card-hover transition-all overflow-hidden">
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-9 h-9 rounded-lg flex items-center justify-center text-base bg-red-500/15 flex-shrink-0">
                        📕</div>
            ...
            <article
                ...
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-9 h-9 rounded-lg flex items-center justify-center text-base bg-fn-green/15 flex-shrink-0">
                        🟩</div>
            ...
            <article
                ...
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-9 h-9 rounded-lg flex items-center justify-center text-base bg-fn-blue/15 flex-shrink-0">
                        🧾</div>
            ...
            <article
                ...
                <div class="flex items-center gap-3 mb-4">
                    <div
                        class="w-9 h-9 rounded-lg flex items-center justify-center text-base bg-purple-500/15 flex-shrink-0">
                        🖼️</div>
