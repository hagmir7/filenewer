@if ($tool->body)
<section class=" pb-3">
    <article class="prose prose-lg max-w-5xl mx-auto px-6
                                prose-p:text-gray-300 prose-p:leading-8 prose-hr:m-0
                                prose-headings:font-semibold prose-headings:tracking-tight
                                prose-h2:text-white prose-h2:text-[24px] prose-h2:mt-3 prose-h2:mb-2 prose-h2:border-b prose-h2:border-gray-800 prose-h2:pb-3
                                prose-h3:text-gray-100 prose-h3:mt-10 prose-h3:mb-4
                                prose-h4:text-gray-200 prose-h4:mt-8 prose-h4:mb-3
