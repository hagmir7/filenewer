<nav class="sticky top-0 z-50 border-b border-white/[0.07] backdrop-blur-xl bg-fn-bg/85">
    <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            {{-- <a href="/my-files"
                class="inline-flex gap-2 items-center whitespace-nowrap px-2 md:px-4 py-1 md:py-2 text-xs md:text-sm font-semibold text-white bg-fn-blue rounded-lg hover:bg-fn-blue-l btn-glow transition-all">
            ...
            <a href="/login"
                class="hidden sm:inline-flex items-center px-2 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-semibold text-fn-text2 border border-white/[0.07] rounded-lg hover:text-fn-text hover:bg-fn-surface hover:border-white/[0.15] transition-all">
                Sign In
            </a>

            <a href="/signup"
                class="inline-flex items-center px-2 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-semibold text-white bg-fn-blue rounded-lg hover:bg-fn-blue-l btn-glow transition-all">
                Start Free
            </a>
