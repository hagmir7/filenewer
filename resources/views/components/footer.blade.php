    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2.5">
                    <li><a href="https://filenewer.com/pages/about-us"
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2.5">
                    <li><a href="https://filenewer.com/pages/privacy-policy"
                            class="text-fn-text2 text-sm hover:text-fn-text transition-colors">Privacy Policy</a>
                    </li>
                    <li><a href="https://filenewer.com/pages/terms-of-service"
                            class="text-fn-text2 text-sm hover:text-fn-text transition-colors">Terms of
                            Service</a></li>
                    <li><a href="https://filenewer.com/pages/gdpr-compliance-policy"
                            class="text-fn-text2 text-sm hover:text-fn-text transition-colors">GDPR</a>
                    </li>
                    <li><a href="https://filenewer.com/pages/security-policy"
        ...
        <div class="pt-7 border-t border-white/[0.07] flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <ul class="flex items-center gap-5 list-none">
                ...
                <li><a href="/sitemap.xml"
                        class="text-fn-text3 text-xs md:text-sm hover:text-fn-text2 transition-colors">Sitemap</a></li>
                <li><a href="/contact"
