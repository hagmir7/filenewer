...
{{-- Inline styles — no @yield('styles') dependency needed --}}
<style>
    .drop-zone {
...
<section class="relative pt-10 pb-6 overflow-hidden tool-glow">
    <div class="max-w-5xl mx-auto px-6 text-center relative z-10">
        <div
            class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-fn-red/30 bg-fn-red/8 text-fn-red text-xs font-semibold tracking-widest uppercase mb-5">
            <span>📕</span> PDF Tools
        </div>
        <h1 class="text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1] mb-4">
            PDF to <span class="text-gradient">Word Converter</span>
        </h1>
        <p class="text-fn-text2 text-lg max-w-xl mx-auto leading-relaxed mb-4">
            Convert any PDF to a fully editable DOCX — preserving formatting, tables, fonts, and images. Free, instant,
            secure.
        </p>
        <div class="flex items-center justify-center gap-6 flex-wrap">
            @foreach(['No account needed', 'Up to 50MB free', 'Deleted after 1 hour', 'AES-256 encrypted'] as $badge)
