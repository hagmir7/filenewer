...
<section class="relative pt-10 pb-6 overflow-hidden tool-glow">
    <div class="max-w-5xl mx-auto px-6 text-center relative z-10">
        <div
            class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-fn-amber/30 bg-fn-amber/8 text-fn-amber text-xs font-semibold tracking-widest uppercase mb-5">
            <span>📎</span> PDF Tools
        </div>
        ...
        <p class="text-fn-text2 text-lg max-w-xl mx-auto leading-relaxed mb-4">
            Combine multiple PDFs into one document in seconds — drag to reorder, then merge. Free, instant, secure.
        </p>
        <div class="flex items-center justify-center gap-6 flex-wrap">
            @php $heroBadges = ['No account needed', 'Up to 20 files free', 'Deleted after 1 hour', 'AES-256
            encrypted']; @endphp
